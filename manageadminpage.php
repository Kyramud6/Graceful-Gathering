...
$query = "SELECT user_id, username, email, user_type FROM users WHERE user_type = 'admin'";
...
<body>
    ...
    <div class="container">
        <div class="sidebar">
            ...
            <nav class="sidebar-nav">
                ...
                <a href="manageadminpage.php" class="nav-item active">Admin</a>                
    ...
    <div id="editFormContainer">
        <form method="POST">
            ...
            <label for="editUsername">Admin Name:</label>
